...
```{r plot_search_volume_accuracy, include = FALSE}
se_labels <- 
...
p <- 
  ...
  scale_y_continuous(limits = c(0.5, 0.8), breaks = seq(0.5, 0.8, 0.1), labels = scales::label_percent(accuracy = 1), expand = expansion(0)) +
  ...
  labs(title = "Search Engine Accuracy by Keyword's Monthly Search Volume",
...
ragg::agg_png(here::here("plots", "plot_01_search_vol_accuracy.png"), width = 9, height = 5, units = "in", res = 320)
print(p)
dev.off()
```
![](../plots/plot_01_search_vol_accuracy.png)
