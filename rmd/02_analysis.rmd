---
title: "Search Engine Comparison Study: Results From 6.5M SERP Results"
...
se_list <- c("Google", "Yahoo", "Bing", "DuckDuck") 
...
df <- 
  ...
  mutate(
    ...
    se_1 = factor(se_1, levels = c("Yahoo", "Bing", "DuckDuck", "Google")),
    se_2 = factor(se_2, levels = c("Yahoo", "Bing", "DuckDuck", "Google")),
    include_exclude = case_when(
      se_1 == se_2 ~ "exclude",
      se_1 == "DuckDuck" & se_2 == "Bing" ~ "exclude",
      TRUE ~ "include"
    ),
...
p <- 
  ...
  scale_x_discrete(limits = c("Yahoo", "Bing", "DuckDuck")) +
  scale_y_discrete(limits = c("Google", "DuckDuck", "Bing")) +
...
We see that volume can make a big difference in some cases, for instance for Health related keywords Bing and DuckDuck become much more accurate as volume increases.
...
search_position_df <- 
  ...
  mutate(
    ...
    search_engine = factor(search_engine, levels = c("Yahoo", "Bing", "DuckDuck"), labels = c("<span style='color:#247ba0'>**Yahoo**</span>", "<span style='color:#f25f5c'>Bing</style>", "<span style='color:#70c1b3'>DuckDuck</span>"))
  )
...
p <- 
  ...
  scale_fill_manual(values = c("Bing_pct" = "#f25f5c", "DuckDuck_pct" = "#70c1b3", "Yahoo_pct" =  "#247ba0", "pct_remainder" = "grey70")) +
  scale_color_manual(values = c("Bing_pct" = "#f25f5c", "DuckDuck_pct" = "#70c1b3", "Yahoo_pct" =  "#247ba0", "pct_remainder" = "grey70")) +
  coord_cartesian(clip = "off") +
