...
We show below the same chart but this time considering the similarity between
top 3, top 20, and top 30.

We see overall that top3 results are more similar than top 10 results.
...
Google for medium volumes  (1000-10000 searches per month), this is true for top 10,
top 20 and top30 for all search engines. 

For high volumes searches (10000-100000 searches per month) a search engine's
rankings are usually less similar to Google's.
...
Google and other search engines is the most similar, while Apparel, Beauty and Personal Care and
Internet & Telecom are the categories showing the most dissimilar top 10.
...
similarity_by_se_and_category_3 %>%
  ...
  coord_flip() +
  scale_y_continuous(labels = scales::label_percent()) +
  labs(title = str_wrap("Search Engine similarity to Google by Keyword Category (level 3)", 30),
       subtitle = "Top 10",
       colour = "Search Engine", 
       x = "Keyword Category",
       y = "Search Engine Similarity")
