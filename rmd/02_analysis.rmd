...
```{r plot_google_similarity, echo=T, results=T}
print(similarity_by_se_and_category, n = Inf)
...
```{r plot_google_similarity_level_2, echo=T, results=T}
print(similarity_by_se_and_category_2, n = Inf)
...
```{r plot_google_similarity_by_vol, echo=T, results=T}
print(similarity_by_se_category_and_vol, n = Inf)
...
```{r plot_similarity_keyword_length, echo = T, results = T}
...
```{r plot_similarity_vol_keyword_length, echo = T, results = T}
...
```{r plot_top_domains_top_result, echo = T, results = T}
top_domains <- 
  top_domains %>%
  mutate(
...
```{r plot_top_domains_top_10_result, echo = T, results = T}
top_domains_10 <- 
  top_domains_10 %>%
  mutate(
    search_engine = fct_recode(search_engine, DuckDuckGo = "DuckDuck")
...
```{r plot_top_domains_top_03_result, echo = T, results = T}
top_domains_3 <- 
  top_domains_3 %>%
  mutate(
    search_engine = fct_recode(search_engine, DuckDuckGo = "DuckDuck")
...
```{r plot_top_domains_top_20_result, echo = T, results = T}
top_domains_20 <- 
  top_domains_20 %>%
  mutate(
    search_engine = fct_recode(search_engine, DuckDuckGo = "DuckDuck")
...
```{r plot_top_domains_top_30_result, echo = T, results = T}
top_domains_30 <- 
  top_domains_30 %>%
  mutate(
    search_engine = fct_recode(search_engine, DuckDuckGo = "DuckDuck")
